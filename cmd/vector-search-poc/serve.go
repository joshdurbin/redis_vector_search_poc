...
import (
	...
	"github.com/joshdurbin/vector_search_poc/internal/server"
...
func serveCmd() *cobra.Command {
	...
	cmd.Flags().String("sqlite-path", "products.db", "SQLite database path")
	...
	viper.BindPFlag("sqlite.path", cmd.Flags().Lookup("sqlite-path"))
